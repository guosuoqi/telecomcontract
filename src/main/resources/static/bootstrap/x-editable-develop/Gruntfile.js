 ...
 ['bs3', 'bootstrap', 'jqueryui', 'plain'].forEach(function(f){
     ['popup', 'inline'].forEach(function(c){
         ['1.7.2', '1.8.3', '1.9.1', '1.10.2', '2.0.3'].forEach(function(jqver) {
             qunit_testover.push('http://localhost:8000/test/index.jsp?f='+f+'&c='+c+'&jquery='+jqver+module);
         });
     });
 });    
  ...
  grunt.initConfig({
    ...
    qunit: {
      bootstrap2: {
          options: {
            urls: [
                  'http://localhost:8000/test/index.jsp?f=bootstrap&c=popup'+module,
                  'http://localhost:8000/test/index.jsp?f=bootstrap&c=inline'+module
                 ]
          }
      },
      bootstrap3: {
          options: {
            urls: [
                  'http://localhost:8000/test/index.jsp?f=bs3&c=popup'+module,
                  'http://localhost:8000/test/index.jsp?f=bs3&c=inline'+module
                 ]
          }
      },
      jqueryui: {
          options: {
            urls:[
                  'http://localhost:8000/test/index.jsp?f=jqueryui&c=popup'+module,
                  'http://localhost:8000/test/index.jsp?f=jqueryui&c=inline'+module
                 ]
          }
      },
      plain: {
          options: {
            urls:[
                  'http://localhost:8000/test/index.jsp?f=plain&c=popup'+module,
                  'http://localhost:8000/test/index.jsp?f=plain&c=inline'+module
             ]
          }
      },
