...
<div class="container-fluid">
    <form id="3GRRUForm" class="form-horizontal">
        <div class="row">
            ...
            <div class="col-xs-4">
                <input class="form-control" name="dxCode" value="${equipmentRRUAAU.dxCode}" id="dxCode" type="text"/>
                <input class="form-control" name="id" value="${equipmentRRUAAU.id}" id="id" type="hidden"/>
            </div>
            <div class="col-xs-2">BBU编码:</div>
            <div class="col-xs-4">
                <input class="form-control" name="rruCode" value="${equipmentRRUAAU.rruCode}" id="bbuCode" type="text"/>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-4">
                <input class="form-control" name="rruName" value="${equipmentRRUAAU.rruName}" id="bbuName" type="text"/>
            </div>
            <div class="col-xs-2">电信网管编码:</div>
            <div class="col-xs-4">
                <input class="form-control" name="netCareId" value="${equipmentRRUAAU.netCareId}" id="NetCareId" type="text"/>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-4">
                <input class="form-control" name="netCareName" value="${equipmentRRUAAU.netCareName}" id="NetCareName" type="text"/>
            </div>
        </div>
    </form>
</div>
