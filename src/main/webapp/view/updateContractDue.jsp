...
<div class="container-fluid">
    <form id="contractFormExtension" class="form-horizontal">
        <div class="row">
            ...
            <div class="col-xs-4">
                <input class="form-control date" name="extensionEnd" value="${contract.payEndTime}" id="extensionEnd" type="text"/>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-4">
                <input class="form-control" name="operator" value="${contract.extenxionOperator}" id="operator" type="text"/>
            </div>
