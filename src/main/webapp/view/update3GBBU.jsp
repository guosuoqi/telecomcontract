...
<div class="container-fluid">
    <form id="3GBBUForm" class="form-horizontal">
        <div class="row">
            <div class="col-xs-2">电信编码:</div>
            <div class="col-xs-4">
                <input class="form-control" name="dxCode" value="${equipmentBBU.dxCode}" id="dxCode" type="text"/>
                <input class="form-control" name="id" value="${equipmentBBU.id}" id="id" type="hidden"/>
            </div>
            <div class="col-xs-2">BBU编码:</div>
            <div class="col-xs-4">
                <input class="form-control" name="bbuCode" value="${equipmentBBU.bbuCode}" id="bbuCode" type="text"/>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-4">
                <input class="form-control" name="bbuName" value="${equipmentBBU.bbuName}" id="bbuName" type="text"/>
            </div>
            <div class="col-xs-2">电信网管编码:</div>
            <div class="col-xs-4">
                <input class="form-control" name="NetCareId" value="${equipmentBBU.netCareId}" id="NetCareId" type="text"/>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-4">
                <input class="form-control" name="NetCareName" value="${equipmentBBU.netCareName}" id="NetCareName" type="text"/>
            </div>
        </div>
    </form>
</div>
