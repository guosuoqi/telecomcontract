        ...
        <form class="form-horizontal">
            <div class="form-group">
                <div class="col-sm-4 "> <%--占4格--%>
                            <label for="bbuNameTc">5GBBU名称</label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-xs-2">5GBBU标识:</div>
                    <div class="col-xs-4">
                ...
                <div class="row">
                    <div class="col-xs-2">5GBBU名称:</div>
                    <div class="col-xs-4">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="buttonAdd" class="btn btn-primary" onclick="submit5GBBU()">
                    提交更改
                </button>
            </div>
        </div><!-- /.modal-content -->
...
<button type="button" onclick="openAdd5GBBU()" class="btn btn-info glyphicon glyphicon-plus">新增</button>
<button type="button" onclick="del5GBBU()" class="btn btn-danger glyphicon glyphicon-minus">删除</button>
...
<script type="text/javascript">
    ...
    function initBBU(){
        $('#5GBBUTable').bootstrapTable('destroy');
        $("#5GBBUTable").bootstrapTable({
            ...
            columns:[
                ...
                {field:'bbuCode',title:'5GBBU标识'},
                {field:'bbuName',title:'5GBBU名称'},
    ...
    function editRRu(id,dxCode,bbuCode,bbuName,power){
        $("#id").val(id);
        $("#dxCode").val(dxCode);
        $("#bbuCode").val(bbuCode);
        $("#bbuName").val(bbuName);
    ...
    //批量删除
    function del5GBBU(){
        var arr = $('#5GBBUTable').bootstrapTable('getSelections');
        if (arr.length <= 0) {
            bootbox.alert({
                size: "small",
                title: "提示",
    ...
    function EXPContract(){
        ...
        bootbox.confirm({
            ...
            callback: function(result){
                ...
                location.href="/poi/createExcel?ids="+ids+"&&type=4"
            }
        })
    }
    //导出模板
    function EXPmoban(){
        location.href="/poi/createExcelMoban?type=4"
    }
    //打开导入弹框
    ...
    function doUpload() {
        ...
        $.ajax({
            ...
            processData: false,
            success: function (result) {
                $('#5GBBUTable').bootstrapTable('refresh');
            },
            error: function () {
                alert(result.msg);
            }
