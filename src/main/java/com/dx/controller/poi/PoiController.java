...
public class PoiController {
        ...
        public void createExcel(HttpServletRequest request, HttpServletResponse response, String ids) throws IOException {
            ...
            try {
                ...
                for (int i = 0; i <list.size() ; i++) {
                    ...
                    row3.createCell(0).setCellValue(list.get(i).getContractId());
                    ...
                    row3.createCell(5).setCellValue(list.get(i).getContractNum());
                    row3.createCell(6).setCellValue(list.get(i).getContractFirst());
                    row3.createCell(7).setCellValue(list.get(i).getPayee());
                    row3.createCell(8).setCellValue(list.get(i).getPlanYear());
                    row3.createCell(9).setCellValue(list.get(i).getStartTime());
                    row3.createCell(10).setCellValue(list.get(i).getEndTime());
                    row3.createCell(11).setCellValue(list.get(i).getPayEndTime());
                    row3.createCell(12).setCellValue(list.get(i).getRoomTypeName());
                    row3.createCell(13).setCellValue(list.get(i).getTowerTypeName());
                    row3.createCell(14).setCellValue(list.get(i).getContractTypeName());
                }
                //输出Excel文件
    ...
    private HSSFRow getHeadRow(HSSFSheet sheet) {
        ...
        //创建单元格并设置单元格内容
        row2.createCell(0).setCellValue("合同id");
        ...
        row2.createCell(5).setCellValue("合同编号");
        row2.createCell(6).setCellValue("合同甲方");
        row2.createCell(7).setCellValue("收款人");
        row2.createCell(8).setCellValue("拟租年份");
        row2.createCell(9).setCellValue("开始时间");
        row2.createCell(10).setCellValue("结束时间");
        row2.createCell(11).setCellValue("付费截止日期");
        row2.createCell(12).setCellValue("机房类型");
        row2.createCell(13).setCellValue("塔栀类型");
        row2.createCell(14).setCellValue("合同类型");
        return row2;
    }
